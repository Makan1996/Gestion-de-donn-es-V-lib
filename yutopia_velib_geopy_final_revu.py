...
if location:
    ...
    m = folium.Map(location=[location.latitude, location.longitude],  tiles=None, zoom_start=16)
    ...
    mydb = myclient["velib_db"]
    mycol = mydb["velib_collection"]
    Cursor = mycol.find()
    ...
    for station in tablo_stations:
        ...
        print(station)
        station_location = (station['coordonnees_geo'][0], station['coordonnees_geo'][1])
        ...
        if distance < 500:
            ...
            street_view_url = f"https://www.google.com/maps/@?api=1&map_action=pano&viewpoint={station['coordonnees_geo'][0]},{station['coordonnees_geo'][1]}"
            ...
            folium.Marker([station['coordonnees_geo'][0], station['coordonnees_geo'][1]],
